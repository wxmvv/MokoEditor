...
export interface TreeRenderProps<T = any, C extends string = never> {
	...
	renderItemsContainer?: (props: { children: React.ReactNode; containerProps: HTMLProps<any>; info: TreeInformation; depth: number; parentId: TreeItemIndex }) => React.ReactElement | null;

	renderTreeContainer?: (props: { children: React.ReactNode; containerProps: HTMLProps<any>; info: TreeInformation }) => React.ReactElement | null;

	renderDragBetweenLine?: (props: { draggingPosition: DraggingPosition; lineProps: HTMLProps<any> }) => React.ReactElement | null;
